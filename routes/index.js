 ...
 JOIN 
  ...
  try {
    ...
    relationshipsArr.forEach((relationship) => {
      const person1Node = nodes.find(
        (node) => node.person.personID === relationship.person1ID
      );
      const person2Node = nodes.find(
        (node) => node.person.personID === relationship.person2ID
      );
